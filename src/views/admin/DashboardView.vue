         ...
         <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
               ...
               <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
                  <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-white">Homilías</span>
               </a>
            </div>
                     ...
                     <ul class="py-1" role="none">
                        <li>
                           <a href="#" class="block px-4 py-2 text-sm text-white hover:bg-gray-100 hover:text-gray-700"
                              role="menuitem">Homilías</a>
                        </li>
                        <li>
                           <a href="#" class="block px-4 py-2 text-sm text-white hover:bg-gray-100 hover:text-gray-700"
                              role="menuitem">Oración de la mañana </a>
                        </li>
                        <li>
                           <a href="#" class="block px-4 py-2 text-sm text-white hover:bg-gray-100 hover:text-gray-700" role="menuitem"
