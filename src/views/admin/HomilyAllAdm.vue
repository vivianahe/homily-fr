...
import FormularioEditar from "@/components/Admin/Homilia/FormularioAgregar.vue";


const dataHomilies = ref([]);
const dataForm = reactive({
  componet: markRaw(FormularioAgregar),
  nameModal: "Agregar Homilias"
});
...
const editar = (id) => {
  ...
  //abrir el mismo modal
  dataForm.componet = markRaw(FormularioEditar); // Marcar el nuevo componente como no reactivo
  dataForm.nameModal = "Editar Homilias";
  console.log("editarrrr");
  console.log("editarrrr", id);
}
