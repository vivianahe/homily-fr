        ...
        <div class="flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0">
            <div class="flex flex-col sm:flex-row rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0">
                            ...
                            <div v-if="error"
                                ...
                                <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                                    <svg class="fill-current h-6 w-6 text-red-500 cursor-pointer" role="button"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" @click="closeAlert">
                                        <title>Cerrar</title>
                                        <path
                            ...
                            <form class="form-horizontal w-3/4 mx-auto" @submit.prevent="login">
                                <div class="py-4">
                                    ...
                                    <input v-model="email" type="email" name="email" id="email"
                                        aria-label="Correo electrónico" aria-describedby="email-help"
                                ...
                                <div class="py-4">
                                    ...
                                    <input v-model="password" type="password" name="password" id="password"
                                        aria-label="Contraseña" aria-describedby="password-help" placeholder="••••••••"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                        required />
                ...
                <div class="hidden md:block md:w-1/2 rounded-r-lg"
                    style="background: url('/img/img_login.jpg'); background-size: cover; background-position: center center;">
                </div>
            </div>
        </div>
    </div>
